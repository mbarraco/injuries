...
# Resolved from __file__, not the cwd: the previous relative path only worked
# when the script happened to be invoked from the repo root. (`BASE` in this
# module is the API URL, hence a separate constant.)
REPO_ROOT = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
SEASONS_FILE = os.path.join(REPO_ROOT, "data", "reference", "sportmonks",
                            "seasons.json")
